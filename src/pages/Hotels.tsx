...
const hotelSlides: HeroSlide[] = [
  ...
  { image: patternRoses, topLine: "BEACH RESORTS", mainText: "All-Inclusive", subText: "From £99/night • Beachfront properties • Spa included", topLineClass: "text-lg md:text-2xl font-black text-white uppercase tracking-wide", mainTextClass: "font-display text-5xl md:text-7xl lg:text-8xl font-black text-white italic", subTextClass: "text-lg md:text-xl text-accent font-black", textPosition: "center" },
  ...
  { image: patternGeometric, topLine: "TROPICAL RETREATS", mainText: "Thailand £59", subText: "Per night • 4-star beachfront • Breakfast included", topLineClass: "text-lg md:text-xl font-black text-white uppercase tracking-wide italic", mainTextClass: "font-display text-6xl md:text-8xl lg:text-9xl font-black text-white", subTextClass: "text-xl md:text-2xl text-accent font-black", textPosition: "center" },
  ...
  { image: patternBotanical, topLine: "SPA & WELLNESS", mainText: "Relax & Unwind", subText: "Spa hotels from £89/night • Treatments included", topLineClass: "text-sm md:text-base font-black text-white uppercase tracking-[0.5em] italic", mainTextClass: "font-display text-6xl md:text-8xl lg:text-[7rem] font-black text-white italic", subTextClass: "text-xl md:text-2xl text-accent font-bold", textPosition: "center" },
  ...
  { image: patternWatercolor, topLine: "ADVENTURE LODGES", mainText: "Eco Stays", subText: "Mountain lodges & treehouses • Nature immersion", topLineClass: "text-base md:text-lg font-black text-white/90 uppercase tracking-[0.3em]", mainTextClass: "font-display text-5xl md:text-7xl lg:text-8xl font-black text-white", subTextClass: "text-xl md:text-2xl text-white font-black", textPosition: "center" },
