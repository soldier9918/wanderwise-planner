        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong className="text-foreground">Analytics cookies:</strong> Help us understand how visitors interact with TravelZentra so we can improve our service.</li>
          ...
          <section>
            ...
            <p>You can manage your cookie preferences through your browser settings or via our <a href="/privacy-settings" className="text-primary hover:underline">Privacy Settings</a> page. Please note that disabling certain cookies may affect your experience on TravelZentra.</p>
          </section>
        </div>
      </main>
      <Footer />
