...
const flightSlides: HeroSlide[] = [
  ...
  { image: patternGeometric, topLine: "SUMMER FLIGHTS", mainText: "From £29 One Way", subText: "Short-haul European getaways • Direct flights", topLineClass: "text-lg md:text-2xl font-black text-white uppercase tracking-wide", mainTextClass: "font-display text-6xl md:text-8xl lg:text-9xl font-black text-white", subTextClass: "text-lg md:text-xl text-accent font-black", textPosition: "center" },
  ...
  { image: patternFloral, topLine: "USA FLIGHTS", mainText: "New York £249", subText: "Direct from London • Multiple airlines", topLineClass: "text-lg md:text-xl font-black text-accent uppercase tracking-[0.25em] italic", mainTextClass: "font-display text-6xl md:text-8xl lg:text-9xl font-black text-white", subTextClass: "text-lg md:text-2xl text-white/85 font-bold", textPosition: "center" },
  ...
  { image: patternRoses, topLine: "WEEKEND ESCAPES", mainText: "Fly from £19", subText: "Friday to Sunday breaks • Budget airlines included", topLineClass: "text-lg md:text-xl font-black text-accent uppercase tracking-widest", mainTextClass: "font-display text-6xl md:text-8xl lg:text-9xl font-black text-white italic", subTextClass: "text-lg md:text-2xl text-white/80 font-bold", textPosition: "center" },
  ...
  { image: patternBotanical, topLine: "FIRST CLASS", mainText: "Fly in Style", subText: "Luxury airlines • Lie-flat seats • Lounge access", topLineClass: "text-lg md:text-xl font-black text-accent uppercase tracking-[0.25em]", mainTextClass: "font-display text-5xl md:text-7xl lg:text-8xl font-black text-white italic", subTextClass: "text-xl md:text-2xl text-white/80 font-bold", textPosition: "center" },
  ...
  { image: patternWatercolor, topLine: "AFRICA SALE", mainText: "Cape Town £399", subText: "Return flights • Premium carriers • 10h direct", topLineClass: "text-lg md:text-xl font-black text-white uppercase tracking-[0.3em]", mainTextClass: "font-display text-5xl md:text-7xl lg:text-8xl font-black text-white", subTextClass: "text-xl md:text-2xl text-white/85 font-bold", textPosition: "center" },
