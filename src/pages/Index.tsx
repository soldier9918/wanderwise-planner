...
const packageSlides: HeroSlide[] = [
  { image: heroBg1, topLine: "SUMMER SALE", mainText: "Save up to £300", subText: "On package holidays to top destinations", topLineClass: "text-lg md:text-xl font-black text-amber-300 uppercase tracking-[0.25em] italic font-outfit", mainTextClass: "font-bebas text-6xl md:text-8xl lg:text-9xl font-black text-white tracking-wide", subTextClass: "text-lg md:text-2xl text-white/90 font-bold font-body", textPosition: "center" },
  ...
  { image: heroParis, topLine: "ROMANTIC PARIS", mainText: "From £249pp", subText: "Eurostar + boutique hotel • Weekend breaks", topLineClass: "text-lg md:text-xl font-bold text-pink-300 uppercase tracking-[0.35em] italic font-lora", mainTextClass: "font-playfair text-6xl md:text-8xl lg:text-9xl font-black text-accent italic", subTextClass: "text-lg md:text-2xl text-white/85 font-bold font-outfit", textPosition: "right" },
