...
const packageSlides: HeroSlide[] = [
  { image: heroBg1, topLine: "Find Your Perfect", mainText: "Package Holiday", subText: "Search hotels & flights across all your favourite brands — all in one place.", topLineClass: "text-2xl md:text-3xl font-bold text-white italic tracking-wide font-playfair", mainTextClass: "font-playfair text-6xl md:text-8xl lg:text-9xl font-black text-white italic", subTextClass: "text-lg md:text-2xl text-white/85 font-medium italic font-outfit", textPosition: "center", highlightClass: "bg-accent px-6 py-2 inline-block rounded-sm" },
