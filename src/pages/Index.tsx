...
const packageSlides: HeroSlide[] = [
  { image: heroBg1, topLine: "Find Your Perfect", mainText: "Package Holiday", subText: "Search hotels & flights across all your favourite brands — all in one place.", topLineClass: "font-playfair text-6xl md:text-8xl lg:text-9xl font-black text-white italic drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)]", mainTextClass: "font-playfair text-6xl md:text-8xl lg:text-9xl font-black text-white italic drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)]", subTextClass: "text-lg md:text-2xl text-white/90 font-medium italic font-outfit", textPosition: "center", highlightClass: "bg-accent px-6 py-2 inline-block rounded-md" },
