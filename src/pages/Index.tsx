...
const packageSlides: HeroSlide[] = [
  { image: heroBg1, topLine: "TRAVELZENTRA", mainText: "Your Journey, Our Passion", subText: "Compare flights, hotels & packages — save up to 40%", topLineClass: "text-lg md:text-xl font-black text-amber-300 uppercase tracking-[0.25em] italic font-outfit", mainTextClass: "font-bebas text-6xl md:text-8xl lg:text-9xl font-black text-white tracking-wide", subTextClass: "text-lg md:text-2xl text-white/90 font-bold font-body", textPosition: "center" },
